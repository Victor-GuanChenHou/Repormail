...
for i in range(len(brand)):
    ...
    total_daily_sales_py+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["Daily Sales PY"])
    ...
    total_daily_tc_cy+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["Daily TC CY"])
    total_daily_tc_py+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["Daily TC PY"])
    ...
    total_mtd_sales_cy+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["MTD Sales CY"])
    total_mtd_sales_py+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["MTD Sales PY"])
    ...
    total_mtd_tc_cy+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["MTD TC CY"])
    total_mtd_tc_py+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["MTD TC PY"])
    ...
    total_ytd_sales_cy+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["YTD Sales CY"])
    total_ytd_sales_py+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["YTD Sales PY"])
    ...
    total_ytd_tc_cy+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["YTD TC CY"])
    total_ytd_tc_py+= sum(0 if x is np.nan or x is None or x is pd.N else x for x in data["YTD TC PY"])
